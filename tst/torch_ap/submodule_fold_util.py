...
def convert_to_submodules_graph(
    ...
    subgraph_ranges_from_non_placeholder: list[(int, int)] = None,
    submodule_hook=None,
    submodule_name_prefix="submodule",
    chain_style=False,
    ...
    """
    gm = copy.deepcopy(gm)
    subgraph_ranges = subgraph_ranges_from_non_placeholder
    ...
    range_idx2range = get_range_idx2range_by_subgraph_ranges()
